...
const projects = [
  {
    ...
    badge: "ENTERPRISE",
    technologies: ["Java", "TypeScript", "Playwright", "Appium", "WebdriverIO"],
  ...
  },
  {
    ...
    badge: "FRAMEWORK",
    technologies: ["JavaScript", "WebdriverIO", "Playwright", "Mocha"],
  ...
  },
  {
    ...
    badge: "FRAMEWORK",
    technologies: ["TypeScript", "Playwright", "Cucumber", "API Testing"],
