...
const timelineEvents = [
  {
    ...
    achievements: [
      "Designed a 7-agent AI Claude Code orchestrationsystem enhancing feature delivery speed by 70%.",
      "Achieved high test coverage for critical modules with +1000 tests (unit/integration/functional(e2e)) and android/ios mobile tests via appium. ",
